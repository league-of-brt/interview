...
对此，我们可以参考MySQL的数据落地过程，所有写入先在内存buffer中完成操作，再择机写入aof文件，我们把该buffer称为aof_buf：

![pic](https://brt-1303999354.cos.ap-shanghai.myqcloud.com/QQ%E6%88%AA%E5%9B%BE20210311041105.png)
...
当aof文件超过设置的大小，和比例超过一定量级，就会触发AOF重写。
